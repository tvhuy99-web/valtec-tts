...
# MainActivity is generated by the materialization pipeline. Dump a fixed source
# window around the Kotlin compiler failure before Gradle so the exact generated
# syntax can be patched without guessing.
...
print('Generated MainActivity lines 145-205:')
for index in range(144, min(len(activity_lines), 205)):
    print(f'MainActivity.kt:{index + 1}: {activity_lines[index]}')

raise RuntimeError('Intentional diagnostic stop after dumping generated MainActivity lines 145-205')
