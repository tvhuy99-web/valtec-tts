...
# System-TTS behavior now lives in tracked Kotlin sources. This packaging step
# deliberately verifies the contract instead of rewriting the service late in
# CI, so the APK cannot silently diverge from the reviewed source.
