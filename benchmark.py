...
def run_inference(model, inputs, n_runs=10, warmup=3):
    ...
    audio_length = audio.shape[-1] / 44100
    ...
    return {
        ...
        'rtf': np.mean(times) / audio_length
    }
...
def main():
    ...
    test_texts = [
        "Xin chào các bạn",
        "Hôm nay thời tiết rất đẹp, trời trong xanh và nắng ấm áp.",
        "Việt Nam là một quốc gia nằm ở vùng Đông Nam Á, có lịch sử và văn hóa lâu đời với nhiều di sản được UNESCO công nhận.",
    ]
